...
.grid{{display:grid;grid-template-columns:1fr;gap:1px;background:var(--line)}}figure{{margin:0;background:#fff;padding:10px}}figure img{{display:block;width:100%;max-width:1280px;margin:auto;aspect-ratio:1280/1064;object-fit:contain;background:#101416;cursor:zoom-in}}figcaption{{max-width:1280px;margin:auto;font-size:13px;font-weight:700;padding-top:8px}}
